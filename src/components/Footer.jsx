      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 bg-primary-500/20 text-primary-600 dark:text-primary-400 px-6 py-3 rounded-lg hover:bg-primary-500/30 transition-colors shadow-md"
          >
            <FiLogIn size={20} /> Admin Login
          </motion.button>
        </div> */}
